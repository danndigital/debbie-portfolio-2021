        ...
        <section className="case-study">
          ...
          >
            <FaGithub className="case-study_icon"  />
                ...
                <img src="./images/dosha-quiz-code.png" alt="dosha quiz code block" className="case-study_imgs" />
                ...
                <img src="./images/dosha-quiz.png" alt="dosha quiz questions example" className="case-study_imgs" />
